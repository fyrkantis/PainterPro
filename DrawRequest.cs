...
public class DrawRequest
{
	...
	{
		Dictionary<string, string> appsettings = PainterPro.Website.appsettings;
		X509Certificate2Collection certificates = PainterPro.Website.certificates;
		string swishDomain = PainterPro.Website.swishDomain;
		string swishPath = PainterPro.Website.swishPath;
		...
		PainterPro.MyConsole.WriteData("	Sent data", contentString + " PUT " + swishDomain + swishPath + uuid);

		try
		{
		Task<HttpResponseMessage> swishConnection = client.PutAsync(swishPath + uuid, content);
